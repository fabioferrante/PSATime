plugins {
    ...
    id("kotlin-kapt") // Adicione para Room
}

android {
    namespace = "com.fabio.psatime"
    compileSdk {
        version = release(36)
    }
    ...
    buildFeatures {
        viewBinding = true // Ativa o View Binding
    }
}
...
dependencies {
    ...
    // Navigation Component (para navegar entre telas)
    implementation("androidx.navigation:navigation-fragment-ktx:2.7.7")
    implementation("androidx.navigation:navigation-ui-ktx:2.7.7")

    // ViewModel (para a lógica de UI)
    implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:2.8.1")
    implementation("androidx.lifecycle:lifecycle-livedata-ktx:2.8.1")
    implementation("androidx.fragment:fragment-ktx:1.8.0") // Para 'viewModels()'
