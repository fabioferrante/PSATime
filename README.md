...
\- Integração futura via SDK e API  
...
\- \[ SDK (JavaScript / Python)](#-sdk-javascript--python)
...
\# Licença \*\*Aurora-7 Royalty License\*\*
...
\- \[`docs\_api.md`](./docs/docs\_api.md) — visão geral da API  

\- \[`sdk\_guide.md`](./docs/sdk\_guide.md) — guia do SDK  
